...
Process {
    ...
    $adkGenericURL = (Invoke-WebRequest -Uri 'https://go.microsoft.com/fwlink/?linkid=2290227' -MaximumRedirection 0 -UseBasicParsing -ErrorAction SilentlyContinue)

    # 302 = redirect as moved temporarily
    # 301 = Moved Permanently
    if ($adkGenericURL.StatusCode -eq 302) {

        # Currently set to https://download.microsoft.com/download/2/d/9/2d9c8902-3fcd-48a6-a22a-432b08bed61e/ADK/
        #  Resolving download root for: https://go.microsoft.com/fwlink/?linkid=2290227
...
266=Windows Assessment Toolkit (DesktopEditions)-x86_en-us.msi
267=Windows Assessment Toolkit (OnecoreUAP)-x86_en-us.msi
268=Windows Deployment Customizations-x86_en-us.msi
269=Windows Deployment Image Servicing and Management - Headers and Libraries-x86_en-us.msi
270=Windows Deployment Image Servicing and Management Tools (DesktopEditions)-x86_en-us.msi
271=Windows Deployment Image Servicing and Management Tools (OnecoreUAP)-x86_en-us.msi
272=Windows Deployment Tools Environment-x86_en-us.msi
273=Windows Deployment Tools-x86_en-us.msi
274=Windows Setup Files (ClientCore)-x86_en-us.msi
275=Windows Setup Files (DesktopEditions)-x86_en-us.msi
276=Windows Setup Files (Holographic)-x86_en-us.msi
277=Windows Setup Files (OnecoreUAP)-x86_en-us.msi
278=Windows Setup Files (ShellCommon)-x86_en-us.msi
279=Windows System Image Manager-x86_en-us.msi
280=WPT Redistributables-x86_en-us.msi
281=WPTarm64 (DesktopEditions)-arm64_en-us.msi
282=WPTarm64 (OnecoreUAP)-arm64_en-us.msi
283=WPTx64 (DesktopEditions)-x64_en-us.msi
284=WPTx64 (DesktopEditions)-x86_en-us.msi
285=WPTx64 (OnecoreUAP)-x64_en-us.msi
286=WPTx64 (OnecoreUAP)-x86_en-us.msi
287=WPTx86 (DesktopEditions)-x86_en-us.msi
288=WPTx86 (OnecoreUAP)-x86_en-us.msi
'@
        }
