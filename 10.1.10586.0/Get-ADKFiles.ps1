...
Process {
    ...
    $adkGenericURL = (Invoke-WebRequest -Uri http://go.microsoft.com/fwlink/?LinkID=618575  -MaximumRedirection 0 -ErrorAction SilentlyContinue)
    
    # 302 = redirect as moved temporarily
    if ($adkGenericURL.StatusCode -eq 302) {

        # Currently set to http://download.microsoft.com/download/3/8/B/38BBCA6A-ADC9-4245-BCD8-DAA136F63C8B/adk
        # Resolving download root for: http://go.microsoft.com/fwlink/?LinkID=618575
        ...
        $InstallerURLs = DATA {
            ConvertFrom-StringData @'
                ...
                150=SQLServer2012-KB3045321-x86.exe
                ...
                173=WP_CPTT_NT-x86-fre.msi
                174=WPT Redistributables-x86_en-us.msi
                175=WPTarm-arm_en-us.msi
                176=WPTx64-x86_en-us.msi
                177=WPTx86-x86_en-us.msi
'@
        }
